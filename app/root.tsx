  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta property="og:url" content="https://map.lamangintel.net" />
        ...
        <meta property="og:image" content="https://map.lamangintel.net/assets/gzw_twitter.jpg" />
        <meta property="og:email" content="info@map.lamangintel.net" />

        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@site" />
        <meta name="twitter:creator" content="@creator" />
        <meta name="twitter:image" content="https://map.lamangintel.net/assets/gzw_twitter.jpg" />
        <Meta />
        <Links />
      </head>
      <body>
